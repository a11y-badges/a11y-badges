...
* `badgeColor`
  * a [css color name](https://developer.mozilla.org/en-US/docs/Web/CSS/color_value), hex value, or rgb/rgba value - e.g. `red`, `1CE0E3`, `rgb(70,130,180)`, `rgba(127,212,190,0.46)`
  * example:
