...
* `textColor`
  * a [css color name](https://developer.mozilla.org/en-US/docs/Web/CSS/color_value), hex value, or rgb value - e.g. `red`, `#1CE0E3`, `rgb(70,130,180)`
  * example:
    * ![text color example](https://a11ybadges.com/badge?text=a11y%20badges&textColor=CBEFF6)
    * `https://a11ybadges.com/badge?text=a11y%20badges&textColor=CBEFF6`
